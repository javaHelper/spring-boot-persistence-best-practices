...
public class CustomSequenceIdGenerator extends SequenceStyleGenerator {
    ...
    public void configure(Type type, Properties params, ServiceRegistry serviceRegistry) throws MappingException {
        BasicType<Long> registeredType = new TypeConfiguration().getBasicTypeRegistry().getRegisteredType(Long.class.getName());
        super.configure(registeredType, params, serviceRegistry);
